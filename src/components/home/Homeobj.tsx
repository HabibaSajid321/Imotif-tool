...
const Homeobj = () => {
  return (
    <div className="flex flex-col bg-gradient-to-b from-yellow-50 via-green-50 to-blue-50 ">
      ...
      <div className=" flex flex-row border-2 border-yellow-200 m-10 gap-10 rounded-2xl shadow-2xl lg:w-[1180px] w-full justify-center content-center">
        <div className="w-1/2">
          <Image
            src={homeimg1}
            alt="Home image"
        ...
        <div className="w-1/2 rounded-lg px-4 text-black pt-2">
          ...
          <ul className="list-disc pl-6 pt-3">
            <li>
              ...
              gene regulation and genomic stability. It aims to explore how loop
              length variations affect their thermal stability.
            </li>
            <li>
